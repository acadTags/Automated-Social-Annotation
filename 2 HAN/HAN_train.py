...
tf.app.flags.DEFINE_string("training_data_path_bib","../datasets/bibsonomy_preprocessed_merged_for_HAN_final.txt","path of traning data.") # for bibsonomy dataset
...
def main(_):
    ...
    if FLAGS.dataset == "bibsonomy-clean":
        ...
        vocabulary_word2index_label,vocabulary_index2word_label = create_voabulary_label(voabulary_label=traning_data_path, name_scope=FLAGS.dataset + "-HAN", label_freq_th = 0)
