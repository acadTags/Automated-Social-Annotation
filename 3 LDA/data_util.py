...
def load_data_multilabel_new(vocabulary_word2index,vocabulary_word2index_label,keep_label_percent=1,valid_portion=0.111,test_portion=0.1,max_training_data=1000000,traning_data_path='',multi_label_flag=True,use_seq2seq=False,seq2seq_label_length=6):  # n_words=100000,
    """
    input: a file path
...
def load_data_multilabel_new_k_fold(vocabulary_word2index,vocabulary_word2index_label,keep_label_percent=1,kfold=10,test_portion=0.1,max_training_data=1000000,traning_data_path='',multi_label_flag=True,use_seq2seq=False,seq2seq_label_length=6):
    """
    input: a file path
